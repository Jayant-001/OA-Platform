...
export function UserActivityDetailsModal({ isOpen, onClose, userName }: Props) {
                ...
                <DialogHeader>
                    <DialogTitle className="flex items-center justify-between">
                        ...
                        <Badge variant="outline" className="bg-purple-50 text-purple-700 border-purple-200">
                            Total Offline Time: {formatDuration(mockDetails.totalOfflineInSeconds)}
                        </Badge>
                    </DialogTitle>
                </DialogHeader>
                <DialogBody>
                    <div className="max-h-[60vh] overflow-y-auto pr-2">
                        <div className="space-y-1">
                            {mockDetails.activities.map((log, index, array) => {
