  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4">Coding Contests</h1>
          <Input
        ...
        <Tabs defaultValue="live" className="space-y-6">
          ...
          {loading ? (
            ...
            <>
              <TabsContent value="live" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <TabsContent value="past" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
